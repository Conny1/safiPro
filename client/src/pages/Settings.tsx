...
const Settings = () => {
  ...
  const tabs = [
    ...
    { id: "billing", label: "Billing", icon: CreditCard, available: user.role === USER_ROLES.SUPER_ADMIN },
  ];
              ...
              <div className="p-6 border-t border-gray-200">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-sm font-medium text-gray-900">
                      {new Date(user.createdAt || Date.now()).toLocaleDateString('en-KE', { month: 'short', year: 'numeric' })}
                    </span>
                  </div>
                  <div className="flex justify-between items-center">
                      ...
                      <div className="bg-gradient-to-r from-purple-50 to-purple-100 border border-purple-200 rounded-xl p-6">
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <p className="text-sm text-gray-600 mt-1">2.5 GB of 10 GB used</p>
                          </div>
                    ...
                    <div className="border border-gray-200 rounded-xl p-6">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="pt-4 border-t border-gray-200">
                          ...
                          <button className="px-4 py-2 text-sm font-medium text-red-600 bg-red-50 hover:bg-red-100 rounded-lg">
