        ...
        <div className="bg-white shadow-md rounded-lg overflow-hidden">
          <table className="text-left w-full">
            ...
            {findloading ? (
              ...
              <tbody className=" max-h-[50vh] bg-grey-light flex flex-col items-center overflow-y-scroll w-full">
                {staff.map((item) => (
                  <tr key={item._id} className="flex w-full mb-4">
                    ...
                    {editmodal && (
                      <div className=" absolute w-full  h-full top-0 left-0 bg-black flex items-center  ">
                        <UpdateStaff
